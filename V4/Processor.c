...
void Processor_DecodeAndExecuteInstruction() {
	...
	switch (operationCode) {
		...
		// Instruction MEMADD
		case MEMADD_INST: // Adds operand1 and value located in operand2 address, saves to accumulator
			// Saves operand1 value into accumulator
			registerAccumulator_CPU = operand1;
			...
			// Add the read data to the accumulator register
			registerAccumulator_CPU += registerMBR_CPU.cell;
