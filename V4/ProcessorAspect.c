...
case HALT_INST: if (Processor_PSW_BitState(EXECUTION_MODE_BIT) == 1){
{ 
...
case OS_INST: if (Processor_PSW_BitState(EXECUTION_MODE_BIT) == 1){
{ 
...
case IRET_INST: if (Processor_PSW_BitState(EXECUTION_MODE_BIT) == 1){
{ 
...
case MEMADD_INST: registerAccumulator_CPU = operand1; 
