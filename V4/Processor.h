...
// Enumerated type that states the different types of exceptions
...
// The OS needs to access register B to when executing the exception management
// routine, so it will be able to know the produced exception identifier
